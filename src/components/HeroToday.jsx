...
const HeroToday = (props) => {
    ...
    return (
        <div className="d-flex justify-content-center text-white">
            <Card className="carta text-center border-0 my-3 bg-transparent font-weight-bold text-white">
                <h1 className="fs-2 text-capitalize mt-3">{props.city}</h1>
                <Card.Body>
                    <Card.Title className="fs-1 mb-3 custom-font">
                        {props.today.tempPerc}&deg;C
                    </Card.Title>
                    <div>
                        {props.today.codeTemp === 0 && (
                            <svg
                                ...
                                height="50"
                                fill="currentColor"
                                class="bi bi-brightness-high-fill text-warning"
                                viewBox="0 0 16 16"
                            >
                        ...
                        {[1, 2, 3].includes(props.today.codeTemp) && (
                            <svg
                                ...
                                height="50"
                                fill="currentColor"
                                class="bi bi-clouds-fill text-white"
                                viewBox="0 0 16 16"
                            >
                        ...
                        {[45, 48].includes(props.today.codeTemp) && (
                            <svg
                                ...
                                height="50"
                                fill="currentColor"
                                class="bi bi-cloud-haze2-fill text-white"
                                viewBox="0 0 16 16"
                            >
                        ...
                        {[51, 53, 55].includes(props.today.codeTemp) && (
                            <svg
                                ...
                                height="50"
                                fill="currentColor"
                                class="bi bi-cloud-sun-fill text-white"
                                viewBox="0 0 16 16"
                            >
                        ...
                        {[61, 63, 65, 66, 67, 80, 81, 82].includes(
                            ...
                            <svg
                                ...
                                height="50"
                                fill="currentColor"
                                class="bi bi-cloud-drizzle-fill text-white"
                                viewBox="0 0 16 16"
                            >
                        ...
                        {[71, 73, 75, 85, 86].includes(
                            ...
                            <svg
                                ...
                                height="50"
                                fill="currentColor"
                                class="bi bi-cloud-snow-fill text-white"
                                viewBox="0 0 16 16"
                            >
                        ...
                        {[95, 96, 99].includes(props.today.codeTemp) && (
                            <svg
                                ...
                                height="50"
                                fill="currentColor"
                                class="bi bi-cloud-lightning-fill text-white"
                                viewBox="0 0 16 16"
                            >
                        ...
                        {![
                            0, 1, 2, 3, 45, 48, 51, 53, 55, 61, 63, 65, 66, 67,
                            80, 81, 82, 71, 73, 75, 85, 86, 95, 96, 99,
                        ].includes(props.today.codeTemp) && (
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="50"
                                height="50"
                                fill="currentColor"
                                class="bi bi-emoji-frown text-white"
                                viewBox="0 0 16 16"
                            >
                    ...
                    <Card.Text>
                        <div className="d-flex justify-content-center mt-3">
                            <p className="fs-3">
                                {props.today.mintemp}&deg;C&nbsp;/&nbsp;
                            </p>
                            <p className="fs-3">{props.today.maxtemp}&deg;C</p>
                        </div>
                    </Card.Text>
                </Card.Body>
            </Card>
