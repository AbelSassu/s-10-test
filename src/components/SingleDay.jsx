        ...
        <Col key={i} className="text-white">
            <div>
                <div className="d-flex justify-content-center fs-3">
                    <p>
                        {getDayOfWeek(results.daily.time[i]).slice(0, 3)}&nbsp;
                    </p>
                ...
                <div>
                    ...
                    {![
                        0, 1, 2, 3, 45, 48, 51, 53, 55, 61, 63, 65, 66, 67, 80,
                        81, 82, 71, 73, 75, 85, 86, 95, 96, 99,
                    ].includes(codtempo) && (
                        <div>
                ...
                <div className="d-flex justify-content-center mt-2">
                    <p className="fs-4">
                        {results.daily.temperature_2m_min[i]}&deg;C&nbsp;/&nbsp;
                    </p>
                    <p className="fs-4">
                        {results.daily.temperature_2m_max[i]}&deg;
                    </p>
                </div>
            </div>
        </Col>
