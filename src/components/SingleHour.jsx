const SingleHour = (props) => {
    const { ora, codtempo, windspeed, gradi, key } = props;

    return (
        <div key={key} className="text-white d-flex border-end border-white">
            <div className="d-flex">
                <p className="mx-5">{ora}</p>
                <div>
                    {codtempo === 0 && (
                        <div>
                            <svg
            ...
            <div className="d-flex">
                <p className="ms-5">{gradi}&deg;C</p>
            </div>
        </div>
    );
};
